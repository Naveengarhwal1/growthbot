...
> Transform your chatbot experience with powerful system prompt customization. Roaster AI uses a sophisticated multi-layered prompt system that adapts to your preferences, project context, and MCP tool usage — making every conversation more personalized and effective.
...
1. **Base System Prompt** - Core Roaster AI behavior
